        ...
        <div class="col-3 product-container">
            <div class="card product">
                ...
                <div class="card-body">
                    ...
                    <p class="card-list">${product.extraInfo}</p>
...
function decreaseQuantity(idProduct) {
    ...
    for (let index = 0; index < arrayIdProductsCart.length; index++) {
        if(arrayIdProductsCart[index] == idProduct){
    ...
    const idLocalStorage = localStorage.getItem(CAR_PRODUCTS);
    if (!idLocalStorage) {
